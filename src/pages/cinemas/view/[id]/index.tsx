...
import { getCinemaById } from 'apiSdk/cinemas';
            ...
            <FormWrapper wrapperProps={{ gap: 3, p: 4 }}>
              ...
              >
                ...
                <FormListItem
                  label="Opening Time"
                  text={
                    data?.opening_time ? format(parseISO(data?.opening_time as unknown as string), 'dd-MM-yyyy') : ''
                  }
                />
                ...
                <FormListItem
                  label="Closing Time"
                  text={
                    data?.closing_time ? format(parseISO(data?.closing_time as unknown as string), 'dd-MM-yyyy') : ''
                  }
                />
