  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Movies Ticket Booking Online: Your Gateway to New, Upcoming, and Current Cinema. Book Your Movie Tickets Online and Enjoy at Your Nearest Theaters"
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1478720568477-152d9b164e26?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxjaW5lbWF8ZW58MHx8fHwxNjk2MzA4NzM4fDA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Movies Ticket Booking Online: Your Gateway to New, Upcoming, and Current Cinema. Book Your Movie Tickets Online and Enjoy at Your Nearest Theaters`}
            </Text>
            <Box
            ...
            >
              <Stack direction={{ md: 'row', base: 'column' }} spacing="1.5rem">
                <Card userTypeName="Ticket Seller" type="ticket-seller" abilities={appConfig.ownerAbilities} />
