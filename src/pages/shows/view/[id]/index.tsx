...
import { getShowById } from 'apiSdk/shows';
          ...
          <>
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              ...
              >
                <FormListItem
                  label="Show Time"
                  text={data?.show_time ? format(parseISO(data?.show_time as unknown as string), 'dd-MM-yyyy') : ''}
                />

                <FormListItem label="Seat Price" text={data?.seat_price} />
